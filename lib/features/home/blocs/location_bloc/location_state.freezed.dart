...
mixin _$LocationState {
  ...
  MainLocationModel? get model => throw _privateConstructorUsedError;
...
abstract class $LocationStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({LocationStatus status, MainLocationModel? model});

  $MainLocationModelCopyWith<$Res>? get model;
}
...
class _$LocationStateCopyWithImpl<$Res, $Val extends LocationState>
  ...
  $MainLocationModelCopyWith<$Res>? get model {
    ...
    return $MainLocationModelCopyWith<$Res>(_value.model!, (value) {
...
class _$LocationStateImpl implements _LocationState {
  const _$LocationStateImpl({required this.status, required this.model});

  @override
  final LocationStatus status;
  @override
  final MainLocationModel? model;

  @override
  String toString() {
    return 'LocationState(status: $status, model: $model)';
  }
...
abstract class _LocationState implements LocationState {
  const factory _LocationState(
      ...
      required final MainLocationModel? model}) = _$LocationStateImpl;

  @override
  LocationStatus get status;
  @override
  MainLocationModel? get model;
